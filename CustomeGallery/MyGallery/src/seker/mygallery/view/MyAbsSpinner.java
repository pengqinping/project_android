...
public abstract class MyAbsSpinner extends MyAdapterView<SpinnerAdapter> {
    ...
    public MyAbsSpinner(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyAbsSpinner(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        initAbsSpinner();
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.MyAbsSpinner, defStyle, 0);

        CharSequence[] entries = a.getTextArray(R.styleable.MyAbsSpinner_entries);
        if (entries != null) {
    ...
    static class SavedState extends BaseSavedState {
        ...
        /**
         * Constructor called from {@link MyAbsSpinner#onSaveInstanceState()}
         */
