...
public abstract class MyAdapterView<T extends Adapter> extends ViewGroup {
    ...
    public interface OnItemClickListener {
         ...
         */
        void onItemClick(MyAdapterView<?> parent, View view, int position, long id);
    }
    ...
    public interface OnItemLongClickListener {
         ...
         */
        boolean onItemLongClick(MyAdapterView<?> parent, View view, int position, long id);
    }
    ...
    public interface OnItemSelectedListener {
         ...
         */
        void onItemSelected(MyAdapterView<?> parent, View view, int position, long id);
         ...
         */
        void onNothingSelected(MyAdapterView<?> parent);
    }
    ...
    class AdapterDataSetObserver extends DataSetObserver {
        ...
        public void onChanged() {
            ...
            if (MyAdapterView.this.getAdapter().hasStableIds() && mInstanceState != null
                    && mOldItemCount == 0 && mItemCount > 0) {
                MyAdapterView.this.onRestoreInstanceState(mInstanceState);
                mInstanceState = null;
            } else {
                rememberSyncState();
            }
        ...
        public void onInvalidated() {
            ...
            if (MyAdapterView.this.getAdapter().hasStableIds()) {
                ...
                mInstanceState = MyAdapterView.this.onSaveInstanceState();
            }
